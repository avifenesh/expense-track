...
// Model configuration - Claude 3.5 Haiku (fast, cost-effective)
// Using US inference profile for on-demand access
export const model = bedrock('us.anthropic.claude-3-5-haiku-20241022-v1:0')
// Fallback model for throttling/overflow: Claude 3.5 Haiku (same model)
export const fastModel = bedrock('us.anthropic.claude-3-5-haiku-20241022-v1:0')
